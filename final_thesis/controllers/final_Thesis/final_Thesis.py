"""final_Thesis controller."""

# You may need to import some classes of the controller module. Ex:
#  from controller import Robot, Motor, DistanceSensor
from controller import Robot, Keyboard, Motion, Motor, Supervisor
...
class Nao (Robot):
    ...
    def printGps(self):
        #p = self.gps.setValues()
        p = [0.4384100121475009, 0.018039312581672167, 0.30541509354241314]
        self.gps = p
        #print('----------gps----------')
